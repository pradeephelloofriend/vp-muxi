            ...
            <div className="col-md-12 col-xl-7">
              <div className='dev-card'>
                <Card className='abt-card dev0-card bg-c-blue '
                  ...
                  <Image src={'https://res.cloudinary.com/depg2aab2/image/upload/v1682665350/vp/mauxi/construction_qeyh9j.png '} alt='' height={35} width={35} />
                      <span className='abt-card-head-title text-white ps-3 '> Recent development works</span>
                    </>}>
